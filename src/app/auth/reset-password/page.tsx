...
export default function ResetPasswordPage() {
  ...
  // Exchange the PKCE code for a session in the browser so updateUser works
  useEffect(() => {
    if (!code) {
        ...
        >
          ...
          {sessionError && (
            <div className="text-center py-4">
              ...
              <a
                ...
                className="inline-block rounded-xl px-6 py-3 text-sm font-bold uppercase tracking-widest text-white"
          ...
          {!sessionReady && !sessionError && (
            <div className="text-center py-8">
              <div className="mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-2 border-current border-t-transparent" style={{ color: "#C6A34E" }} />
              <p className="text-sm" style={{ color: "#8B7355" }}>Verifying your link…</p>
            </div>
          )}
